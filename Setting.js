...
global.github    = 'https://github.com/MAGICAL-KX/Lou-md-bot' ;
global.location  = 'Africa, Harare' ;
...
global.sudo  =  process.env.SUDO || "263789432940" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"KENOBOTS",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://www.youtube.com/@KentonX-tech?sub_confirmation=1' ; 
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'LOU-MD',         // ADD YOUR BOT NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'KENOBOTS',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "KENOX" ,          // ADD YOUR STICKER PACKNAME
  ...
  caption :process.env.CAPTION || "*• lou-м∂ мυℓтι-∂єνι¢є*\n*• ωнαтѕαρρ вσт* ",
  LANG: process.env.THEME || "SECKTOR",
  VERSION: process.env.VERSION || '𝚅.𝟷.0.0'
  //=================================================================================
};
